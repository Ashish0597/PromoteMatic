                                        ...
                                        <div className="d-flex flex-column flex-md-row flex-lg-column justify-content-between gspace-3">
                                            <div className="testimonial-reviewer">
                                                <div className="avatar-container">
                                                    <img src="/assets/images/testimonial-1.jpg" alt="Testimonial Reviewer" className="avatar" />
                                                    <img src="/assets/images/testimonial-2.jpg" alt="Testimonial Reviewer" className="avatar" />
                                                    <img src="/assets/images/testimonial-3.jpg" alt="Testimonial Reviewer" className="avatar" />
                                                    <img src="/assets/images/testimonial-1.jpg" alt="Testimonial Reviewer" className="avatar" />
                                                </div>
