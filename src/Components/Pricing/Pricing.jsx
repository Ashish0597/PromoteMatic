...
function PricingPlanSection(){
    ...
    Growth Solutions Tailored For Every Business
</h2>
                        </div>
                    </AnimateOnScroll>
                            ...
                            <div className="pricing-container">
                                ...
                                <AnimateOnScroll animation="fadeInUp" speed="normal">
                                    <div className="card card-pricing">
                                       <h4>Launch</h4>
<p>Perfect for startups and emerging businesses</p>

<div className="d-flex flex-row gspace-1 align-items-center h-100">
    <span className="plan-badge">Startup Growth Solution</span>
</div>
    ...
    <li><a href="./single_services">SEO Foundation Setup</a></li>
    <li><a href="./single_services">Social Media Management</a></li>
    <li><a href="./single_services">Content Planning Strategy</a></li>
    <li><a href="./single_services">Monthly Performance Reports</a></li>
</ul>
                                    </div>
                                </AnimateOnScroll>
                            </div>
                        ...
                        <div className="col">
                            <AnimateOnScroll animation="fadeInUp" speed="slow">
                                <div className="card card-pricing pricing-highlight">
                                    <div className="spacer" />
                                   <h4>Dominate</h4>
<p>For established brands seeking market leadership</p>

<div className="d-flex flex-row gspace-1 align-items-center">
    <span className="plan-badge featured">
                        ...
                        <div className="col">
                            <div className="pricing-container">
                                ...
                                <AnimateOnScroll animation="fadeInUp" speed="normal">
                                    <div className="card card-pricing">
                                        <h4>Scale</h4>
<p>Designed for growing businesses ready to accelerate</p>
