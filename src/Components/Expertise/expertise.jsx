                ...
                <div className="hero-container">
                    <div className="d-flex flex-column flex-lg-row gspace-5">
                        ...
                        <div className="expertise-title">
                            ...
                            <p>
                                At Promotematic, we specialize in crafting innovative digital marketing strategies that drive real business growth. Our expertise
                            ...
                            <div className="d-flex flex-column flex-md-row gspace-2">
                                ...
                                <AnimateOnScroll animation="fadeInUp">
                                    <div className="card card-expertise card-expertise-counter animate-box">
                                        ...
                                        <p>
                                            We help brands scale with data-driven marketing, high-impact creatives, and performance-focused strategies tailored for fast-growing businesses.
                                        </p>
                                    </div>
                                </AnimateOnScroll>
                            </div>
